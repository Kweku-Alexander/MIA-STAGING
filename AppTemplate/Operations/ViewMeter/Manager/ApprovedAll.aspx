<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ApprovedAll.aspx.cs" Inherits="AppTemplate.Operations.ViewMeter.Manager.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <tr>
            ...
            <legend>AUTHORISED METERS</legend>                 
...
<asp:GridView
                ...
                <%--            AutoGenerateColumns="False"
                    ...
                    <HeaderStyle Width="100px" />
                                ...
                                <asp:BoundField DataField="ExtraRemarks" HeaderText="SPN" ReadOnly="true">
                                    <HeaderStyle ForeColor="White" HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                    <HeaderStyle Width="100px" />
                                </asp:BoundField>
