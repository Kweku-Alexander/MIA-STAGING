<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ApprovedAll.aspx.cs" Inherits="AppTemplate.Operations.ViewMeter.WebForm1" %>
            ...
            <legend> METER NUMBER</legend>  
                    ...
                    <table class="style1">
                                ...
                                <tr>
                                    ...
                                    <td>
                    <asp:TextBox ID="txtmnumber" runat="server" OnTextChanged="txtmnumber_TextChanged" placeholder="Meter Number" OnLeave="searchTextBox_Leave"></asp:TextBox>
                                    </td>
                                    <td>
                    <asp:Button ID="btnsearch" runat="server" Text="Search" OnClick="btnsearch_Click" Height="25px" />
                                    </td>
                                    <td class="auto-style1">&nbsp;</td>
                                    <td>
                    <asp:TextBox ID="Inspected_id" runat="server" placeholder="Inspecter Name" OnTextChanged="Inspected_TextChanged" OnLeave="searchTextBox_Leave"></asp:TextBox>
                    <asp:Button ID="Flied_id" runat="server" Text="Search" OnClick="btnsearch_Flied" />
                                    </td>
                                     <td class="auto-style1">&nbsp;</td>
                                    <td>
                    <asp:TextBox ID="plot_id" runat="server" placeholder="Plot Number" OnTextChanged="Plot_TextChanged" OnLeave="searchTextBox_Leave"></asp:TextBox>
                    <asp:Button ID="plot_button" runat="server" Text="Search" OnClick="btnsearch_Plot" />
                                    </td>
...
<RowStyle BackColor="White"></RowStyle>
        ...
        <tr>
            <td class="auto-style1">
                ...
                <asp:Button ID="Butt_inset" runat="server" OnClick="ExportToExcel2" Text="Export" Visible="false"/>
                <br />
                <p align="center">
                    <asp:Label ID="lblpopup" runat="server" Text="ECG.GH"></asp:Label>
                    <asp:Label ID="oldmeter" runat="server" Text="Label5" Visible="False"></asp:Label>
                    <asp:Label ID="OK" runat="server" Text="OK" Visible="False"></asp:Label>
                </p>
            </td>
        </tr>
        <tr>
